...
gui=figure('figure_position',[750,200],'figure_size',[400,600],'auto_resize','on','background',[14],'figure_name','Rasp Design');
gui.color_map =  graycolormap(50);
...
handles.dummy = 0;
handles.email_box=uicontrol(gui,'unit','normalized','BackgroundColor',[0.9,0.9,0.9],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[13],'FontUnits','points','FontWeight','normal','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,0.95,handleWidth * 2.1875,0.045],'Relief','sunken','SliderStep',[0.01,0.1],'String','Enter your email ID','Style','edit','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','email_box','Callback','email_box_callback(handles)');
handles.text_box=uicontrol(gui,'unit','normalized','BackgroundColor',[0.9,0.9,0.9],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12.5],'FontUnits','points','FontWeight','normal','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,0.89,handleWidth * 2.1875,0.045],'Relief','flat','SliderStep',[0.01,0.1],'String','No File Selected','Style','text','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','text_box','Callback','text_box_callback(handles)');
handles.Choose_Board=uicontrol(gui,'unit','normalized','BackgroundColor',[1,1,1],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','normal','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[5],'Min',[0],'Position',[handleXLeft,0.82,handleWidth,0.055],'Relief','flat','SliderStep',[0.01,0.1],'String','Choose Board|3.0|3.0 A|3.0 N|3.0 H','Style','popupmenu','Value',[1 2 3 4 5],'VerticalAlignment','middle','Visible','on','Tag','Choose_Board','Callback','Choose_Board_callback(handles)');
handles.Choose_Chip=uicontrol(gui,'unit','normalized','BackgroundColor',[1,1,1],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','normal','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,0.82,handleWidth,0.055],'Relief','sunken','SliderStep',[0.01,0.1],'String','Enter Chip Number','Style','edit','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Choose_Chip','Callback','Choose_Chip_callback(handles)'); 

handles.New_Design=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*0,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','New Design','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','New_Design','Callback','New_Design_callback(handles)');
handles.Choose_Design=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*1,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Choose Design ','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Choose_Design','Callback','Choose_Design_callback(handles)');
handles.Open_Design=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*2,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Open Design','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Open_Design','Callback','Open_Design_callback(handles)');
handles.Compile_Design=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*3,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Compile Design','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Compile_Design','Callback','Compile_Design_callback(handles)');
handles.Program_Design=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*4,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Program Design','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Program_Design','Callback','Program_Design_callback()');
handles.View_Routing=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*5,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','View Routing','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','View_Routing','Callback','View_Routing_callback(handles)');
handles.Reset_Com=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*6,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Reset Com','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Reset_Com','Callback','Reset_Com_callback(handles)');

handles.Take_Data=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*0,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Take Data','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Take_Data','Callback','Take_Data_callback(handles)');
handles.Send_Email=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*1,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Send Email','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Send_Email','Callback','Send_Email_callback(handles)');
handles.Load_Data=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*2,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Load Remote Data','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Load_Data','Callback','Load_Data_callback(handles)');
handles.Choose_Netlist=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*3,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Choose Netlist','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Choose_Netlist','Callback','Choose_Netlist_callback(handles)');
handles.Program_Netlist=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*4,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Program Netlist','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Program_Netlist','Callback','Program_Netlist_callback(handles)');
handles.Choose_Swc_List=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*5,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Choose Switches','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Choose_Swc_List','Callback','Choose_Swc_List_callback(handles)');
handles.Program_SwcList=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXRight,handleYStart - handleHeight*6,handleWidth,0.08],'Relief','raised','SliderStep',[0.01,0.1],'String','Program Switches','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','Program_SwcList','Callback','Program_SwcList_callback(handles)');

handles.export_to_fpaa=uicontrol(gui,'unit','normalized','BackgroundColor',[0.8,0.8,0.8],'Enable','on','FontAngle','normal','FontName','mukti narrow','FontSize',[12],'FontUnits','points','FontWeight','bold','ForegroundColor',[0,0,0],'HorizontalAlignment','center','ListboxTop',[],'Max',[1],'Min',[0],'Position',[handleXLeft,handleYStart - handleHeight*6.75,handleWidth * 2.1875,0.06],'Relief','raised','SliderStep',[0.01,0.1],'String','Export to FPAA','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag','export_to_fpaa','Callback','export_to_fpaa_callback(handles)');

exec('~/rasp30/sci2blif/fpaacal_fcn.sce',-1);
exec('~/rasp30/sci2blif/macroblif_gen_fcn.sce',-1);
exec('~/rasp30/sci2blif/macrocab_gen_fcn.sce',-1);
exec('~/rasp30/sci2blif/level1_sim_gen_fcn.sce',-1);
exec('~/rasp30/sci2blif/block_doc_gen_fcn.sce',-1);
exec('~/rasp30/sci2blif/send_email_ip_pw_fcn.sce',-1);
exec('~/rasp30/sci2blif/dsgnmtrcs_fcn.sce',-1);
//exec("~/rasp30/sci2blif/dsgnmtrcs.sce",-1);
exec('~/rasp30/sci2blif/bcd_fcn.sce',-1);
...
function export_to_fpaa_callback(handles)
...
function Compile_Design_callback(handles)
    ...
    if(extension == '.xcos') then
        ...
        clc;
        if show_dsgnmatrics == 0 then pass_num=1; cap_info = tlist('capinfo'); exec('~/rasp30/sci2blif/sci2blif.sce', -1); end
        if show_dsgnmatrics == 1 then
            exec("~/rasp30/sci2blif/dsgnmtrcs.sce",-1);
            pass_num=1; cap_info = tlist('capinfo'); exec('~/rasp30/sci2blif/sci2blif.sce', -1);
            pass_num=2; exec('~/rasp30/sci2blif/sci2blif.sce', -1);
            Board_settings();
            Design_Metrics();
        end
        filebrowser();
    ...
    if(x ~= []) then 
        ...
        if amm_con1 then
            ...
            if (b1==0) then
                ...
                exec('~/rasp30/prog_assembly/libs/scilab_code/tunnel_clb_ver00_gui.sce', -1);
                disp('tunnel , reverse tunnel for clb done');
                exec('~/rasp30/prog_assembly/libs/scilab_code/switch_program_ble_ver00_gui.sce', -1);
...
function View_Routing_callback(handles)
    ...
    if(x ~= []) then 
        ...
        if(x ~= []) then //pads file is in hidden dir
            ...
            //if plcvpr & addvmm then unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path + ' -vmm -route' + brdtype +' -v');
            if plcvpr & addvmm then unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path + ' -route' + brdtype +' -v');
            elseif plcvpr then unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path+ ' -route' + brdtype+' -v');
            //elseif addvmm then unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path + ' -vmm' + brdtype+' -v');
            elseif addvmm then unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path + brdtype+' -v');
            else unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path + brdtype+' -v');
            end
...
function Take_Data_callback(handles)
    ...
    else exec('~/rasp30/prog_assembly/libs/scilab_code/voltage_measurement_gui.sce', -1);
    end    
    disp("Data Collected ");
    filebrowser();
endfunction
...
function Send_Email_callback(handles)
    ...
    if (email_name == []) then
        ...
        exec('~/rasp30/sci2blif/send_email_ip_pw.sce',-1);
    end
endfunction
...
function Load_Data_callback(handles)
    ...
    disp("Loading Data...");
    unix_s('python ~/rasp30/sci2blif/rmunzip.py ' + path)
    exec('~/rasp30/prog_assembly/libs/scilab_code/outhexfile2voltfile_gui.sce', -1);
    ...
    if amm_con1 then 
        ...
        if(extension == '.blif') then 
            ...
            if(x ~= []) then //pads file is in hidden dir
                ...
                unix_s('python ~/rasp30/vpr2swcs/genswcs.py -c ' + path + fname + ' -d '+ path);
                unix_s('mv ' + fname' + '.pads ' + fname + '.place ' + fname + '.net ' + fname + '.route ' +hid_dir);
...
function demo_example_callback(demo_fname,com_prep_index,arb_msg_index)
    global file_name path fname extension;
    unix_g("mkdir ~/rasp30/RASP_Workspace/demo_examples/");
    unix_g("mkdir ~/rasp30/RASP_Workspace/demo_examples/"+demo_fname);
    unix_s("cp ~/rasp30/sci2blif/demo_examples/"+demo_fname+".xcos ~/rasp30/RASP_Workspace/demo_examples/"+demo_fname+"/");
    file_name= "~/rasp30/RASP_Workspace/demo_examples/"+demo_fname+"/"+demo_fname+".xcos"; disp(demo_fname); disp(file_name);
...
function open_document(doc_name)
    [a,b]=unix_g("acroread ~/rasp30/sci2blif/documentation/"+doc_name+" &"); 
...
function doc6_callback()
    ...
    disp('Step 2 of 3');
    unix_g('cd ~/rasp30/sci2blif/documentation && sudo gdebi -n AdbeRdr9.5.5-1_i386linux_enu.deb');
    disp('Step 3 of 3');
    unix_s('cd '+path); 
...
function gui1_callback()
    exec('~/rasp30/sci2blif/fpaacal.sce',-1);
endfunction

function gui4_callback()
    exec("~/rasp30/sci2blif/macroblif_gen_gui.sce");
endfunction

function gui6_callback()
    exec("~/rasp30/sci2blif/macrocab_gen_gui.sce");
endfunction

function gui9_callback()
    exec("~/rasp30/sci2blif/bcd_gui.sce");
endfunction

function gui8_callback()
    exec("~/rasp30/sci2blif/level1_sim_gen_gui.sce");
endfunction

function gui2_callback()
    exec("~/rasp30/sci2blif/block_doc_gen_gui.sce");
endfunction
...
function etc2_callback(handles)
    ...
    exec("~/rasp30/prog_assembly/libs/scilab_code/MakeProgramlilst_CompileAssembly.sce",-1);
    exec('~/rasp30/prog_assembly/libs/scilab_code/finetune_program_ver00_gui.sce', -1);
    exec('~/rasp30/prog_assembly/libs/scilab_code/dc_setup_gui.sce', -1);
    disp('DC setup done');
...
function etc10_callback(handles)
    ...
    csvdir=uigetdir("~/rasp30/RASP_Workspace", "Choose a directory.")
...
function etc14_callback(handles)
    ...
    path="~/rasp30/RASP_Workspace/compilation_check/";
    mkdir(path);
    cd(path);
    ...
    unix_w("cp ~/rasp30/sci2blif/xcos_ref/compilation_check/compile_check_30.xcos "++fname+extension);
    pass_num=1; cap_info = tlist('capinfo'); exec('~/rasp30/sci2blif/sci2blif.sce', -1);
    ...
    unix_w("cp ~/rasp30/sci2blif/xcos_ref/compilation_check/compile_check_30_vmm.xcos "++fname+extension);
    pass_num=1; cap_info = tlist('capinfo'); exec('~/rasp30/sci2blif/sci2blif.sce', -1);
...
function etc15_callback(handles)
    global file_name path fname extension board_num chip_num;
    clc
    exec("~/rasp30/sci2blif/convert2modelica.sce",-1);
...
function doc_block_callback()
    global fname;
    [a,b]=unix_g('firefox ~/rasp30/sci2blif/documentation/block_docs/build/html/'+fname+'.html'); 
    if b == 1 then
...
function doc_full_callback()
    [a,b]=unix_g('firefox ~/rasp30/sci2blif/documentation/block_docs/build/html/index.html'); 
    if b == 1 then
        messagebox("Error opening documentation. ", "Unable to open firefox! ", "scilab")
    end
endfunction
