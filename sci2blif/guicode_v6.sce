...
function demo_example_callback(demo_fname,com_prep_index,arb_msg_index)
    global file_name path fname extension;
    unix_g("mkdir ~/RASP_Workspace/demo_examples/");
    unix_g("mkdir ~/RASP_Workspace/demo_examples/"+demo_fname);
    unix_s("cp ~/rasp30/sci2blif/demo_examples/"+demo_fname+".xcos ~/RASP_Workspace/demo_examples/"+demo_fname+"/");
    file_name= "~/RASP_Workspace/demo_examples/"+demo_fname+"/"+demo_fname+".xcos"; disp(demo_fname); disp(file_name);
...
function etc10_callback(handles)
    ...
    csvdir=uigetdir("~/RASP_Workspace", "Choose a directory.")
...
function etc14_callback(handles)
    ...
    path="~/RASP_Workspace/compilation_check/";
    mkdir(path);
    cd(path);
