...
function id_pw_send_email(handles)
    if chip_num=='13'&board_num==2 then
        unix_s('python ~/rasp30/remote_server/send_email.py '+ email_name + ' ' + fname + ' ' + email_id_string + ' ' + email_pw_string);
        disp("Email Sent!");
    elseif chip_num=='01'&board_num==2 then
        unix_s('python ~/rasp30/remote_server/send_email01.py '+ email_name + ' ' + fname + ' ' + email_id_string + ' ' + email_pw_string);
        disp("Email Sent_01!");
    elseif chip_num=='04'&board_num==3 then
        unix_s('python ~/rasp30/remote_server/send_email02.py '+ email_name + ' ' + fname + ' ' + email_id_string + ' ' + email_pw_string);
        disp("Email Sent_02!");
    else 
